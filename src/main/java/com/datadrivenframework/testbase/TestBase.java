...
import com.datadrivenframework.utility.ResourceHelper;
...
// import com.datadrivenframework.helper.Wait.WaitHelper;
...
public class TestBase {
    ...
    public void loadPropertiesFile() throws IOException{
        ...
        OR = new Properties();
        f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/datadrivenframework/config/config.properties");
    ...
    public String getScreenShot(String imageName) throws IOException{
        ...
        String imagelocation = System.getProperty("user.dir")+"/src/main/java/com/datadrivenframework/screenshot/";
        Calendar calendar = Calendar.getInstance();
        SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
    ...
    public void beforeMethod(Method result) {
        ...
        System.out.println("Run Method " + result.getName());
...
*/
    ...
    public String[][] getData(String excelName, String sheetName){
        System.out.println(System.getProperty("user.dir"));
        String excellocation = System.getProperty("user.dir")+"/src/main/java/com/datadrivenframework/data/"+excelName;
    ...
    public static void updateResultupdateResult(int indexSI,  String screenShotLocation,String response) throws IOException {
        ...
        String resultFile = userDirector + "/src/main/java/com/datadrivenframework/report/TestReport.html";
